...
#
# - The script was intended to be run in parallel using the following command parallel -j 12 'Rscript pHMM_MomnteCarloAnalysis.r 0.000001 {}' ::: `echo {1..17}`
...
# OR for a local set
#Local_Geneset=unlist(All_Genes[grepl("LA|NQ",names(All_Genes))])
...
save(PermAnal,file=paste("PopGen/SweepAll_k",paste(k),"_permutation_x",i,".RData",sep=""))
